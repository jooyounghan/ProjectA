...
2. Particle 및 Emitter에 대한 Rendering 기능 구현
	- Motion Blur / Glow 등으로 사실적인 렌더링 구현

3. 입자 간 인력/척력이 있을 경우, 전체 입자에 대해 연산하지 않고 영향을 받을 수 있는 입자를 찾는 Neighborhood Particle Search 알고리즘 구현
...
gantt
	...
	dateFormat MM-DD
	axisFormat %m-%d
    Particle Manager :a, 04-01, 04-23
    Rendering :b, 04-16, 05-07
    Neighborhood Search :c, 04-30, 05-23
```
